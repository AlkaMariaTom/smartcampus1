...
<div class="wrapper row1">
  <header id="header" class="clear"> 
    ...
    <div id="logo" class="fl_left">
      <h1><a href="indext.php">Smart Campus</a></h1>
      <p>The Campus Online</p>
    </div>
    <div class="fl_right">
...
<div class="wrapper row2">
  <div class="rounded">
    <nav id="mainav" class="clear"> 
      <!-- ################################################################################################ -->
      <ul class="clear">
        <li class="active"><a href="indext.php">Home</a></li>
        <li><a class="drop" href="Faculty_login.php">Faculty</a>
          <!-- <ul>
        ...
        <li><a class="drop" href="Student_login.php">Student</a>
          <!-- <ul>
...
<div class="wrapper">
  <div id="slider">
    <div id="slide-wrapper" class="rounded clear"> 
      <!-- ################################################################################################ -->
      <figure id="slide-1"><a class="view" href="#"><img src="images/download (3).jpg" alt=""></a>
        <figcaption>
      ...
      <figure id="slide-2"><a class="view" href="#"><img src="images/images (3).jpg" alt=""></a>
        <figcaption>
          <h2>Aliquatjusto quisque nam</h2>
          <p>Attincidunt vel nam a maurisus lacinia consectetus magnisl sed ac morbi. Inmaurisus habitur pretium eu et ac vest penatibus id lacus parturpis.</p>
          <p class="right"><a href="#">Continue Reading &raquo;</a></p>
        </figcaption>      </figure>
      <figure id="slide-3"><a class="view" href="#"><img src="images/demo/slider/images (2).png" alt=""></a>
        <figcaption>
          <h2>Aliquatjusto quisque nam</h2>
          <p>Attincidunt vel nam a maurisus lacinia consectetus magnisl sed ac morbi. Inmaurisus habitur pretium eu et ac vest penatibus id lacus parturpis.</p>
          <p class="right"><a href="#">Continue Reading &raquo;</a></p>
      ...
      <div class="group btmspace-30"> 
        ...
        <div class="one_quarter sidebar"> 
          ...
          <div class="sdb_holder">
            <h6>Virtual Tour</h6>
            <div class="mediacontainer"><img src="images/video1.mp4" alt="">
